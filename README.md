...
This project explores **toxic comment classification using Large Language Models (LLMs)**.  
We evaluate the effectiveness of **zero-shot and few-shot prompting strategies** for detecting toxic content in text.
